...
if [[ "${TRAVIS_PULL_REQUEST}" != "false" || "${TRAVIS_REPO_SLUG}" != "CharlesHawkinsCarnegie/testmodel_slug" ]]; then
...
echo "Your new report will be visible at https://CharlesHawkinsCarnegie.github.io/testmodel_slug in a moment."
